 ...
 */
require_once '../lib/db.php'; // Ensure this points to your database access class
?>
...
<div class="edit-users-box">
    ...
    <div class="edit-users-list">
        ...
        foreach ($users as $user) {
            $dataAttributes = 'data-username="' . $user->username . '" ';
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        updateButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                maxApiCallsSelect.value = this.dataset.maxTo integrate database functionalities into the `users.php` file, ensuring that it operates smoothly with user management via a database, here's the completed script with the JavaScript to handle user updates seamlessly:
